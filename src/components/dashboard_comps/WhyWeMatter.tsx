    ...
    return (
        <Box className={styles.outerBox}>
            ...
            <Stack spacing={5} direction="row" width="90%" alignItems="center" justifyContent="center">
                ...
                <iframe width="450" height="240" src="https://www.youtube.com/embed/S8KwpKxRmsc" title="Why us | Leanpitch.com" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            </Stack>
